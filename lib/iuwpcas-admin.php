...
<div class="wrap">
	...
	<ul>
		...
		<li>Direct downloads of the latest release version of the plugin.</li>
		<li>Up-to-date help.</li>
		<li>Bug reporting, issue tracking, and feature requests.</li>
	</ul>
</div>
